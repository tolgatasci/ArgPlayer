...
public class ArgNotification extends Notification {
    ...
    protected static int notifImgResId = R.drawable.mergesoft;
    ...
    public ArgNotification(Context context, String audio, int duration){
        ...
        String NOTIFICATION_CHANNEL_ID = "548853";
        ...
        notification = builder
                ...
                .setTicker("ArgPlayer")
                .setSmallIcon(notifImgResId)
                .build();

       /* notification = new Builder(context)
                .setWhen(System.currentTimeMillis()).setTicker("ArgPlayer").setSmallIcon(notifImgResId).build();*/
